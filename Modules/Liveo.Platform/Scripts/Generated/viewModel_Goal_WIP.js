...
function Goal_ViewModel() {
    ...
    // fill models
    //
    //TODO: wrap inside our own method.
    //ie. 
    ...
    $.ajax({
        ...
        error: function () {
            console.log('Failed to get goal items ');
        }
    });
    ...
    _self.commitEditedGoalModel = function (callbackSuccess, callbackFail) {
        $.ajax('/api/Goal?Id=' + _self.editedGoalModel().Id(), {
     ...
     _self.commitCandidateGoalModel = function (callbackSuccess, callbackFail) {
        ...
        var result = $.ajax('/api/Goal/', {
            ...
            success: function () {
                ...
                console.log('success set addedModel');
